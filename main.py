...
def main() -> None:
    updater = Updater(token=bottoken, defaults=Defaults(parse_mode=ParseMode.HTML, run_async=True, timeout=9), request_kwargs={'con_pool_size': 18, 'read_timeout': 100, 'connect_timeout': 110})
