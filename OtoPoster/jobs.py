...
def tekrarlipostjob(context):
    ...
    try:
        if type(tsdict['tskan']) != list:
            ...
            for tskand in tsdict['tskan']:
                SEND_MEDIA_TYPES[tspostdict['ptip']](tskand, tspostdict['fid'], caption=tspostdict['tscaption'])
...
def gunluk(context):
    ...
    for kullanici in kullanicilar:
        ...
        if kullanici['altsite'] == "1":
            ...
            urlably_kullanan_sayisi += 1
        elif kullanici['site'] == "0":
            urlcik_kullanan_sayisi += 1
        elif kullanici['altsite'] == "0":
            urlcik_kullanan_sayisi += 1
        if kullanici['ozel']:
