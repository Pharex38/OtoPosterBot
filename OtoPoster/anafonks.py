        ...
        for chan in mj['kanal']:
            try:
                ...
                if kayitli == len(mj['kanal']):
                    menu_mesaj += """└<a href="{}">{}</a>""".format("tg://privatepost?channel={}&post=9999999".format(chan[4]), kbilgi.title)
                else:
                    menu_mesaj += """├<a href="{}">{}</a>\n""".format("tg://privatepost?channel={}&post=9999999".format(chan[4]), kbilgi.title)
