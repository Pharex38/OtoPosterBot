...
def ekstralarmenumark():
    return ReplyKeyboardMarkup(keyboard=[['❤️ Beğeni Butonları'], ['📌 Post Sabitleme'], ['🔁 Tekrarlı Post Paylaş', '🍎 iOS Ban Kontrol'], ['↩️ Ana Menü']], resize_keyboard=True, selective=True)
