...
POSTMENU, APIMENU, KANALMENU, EKSTRAMENU, TSKANAL, TSSAAT, TSPOST, BEGENI, APIDEGISTIR, KANALKAYDET, SABLONA, PATPOST, POSTZAMAN, PATZAMAN, CALLALT, ALTAPI, OZELBOTLOG, OZELKAYNAK= range(18)
